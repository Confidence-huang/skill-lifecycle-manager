...
class ManagerPromotionTests(unittest.TestCase):
    ...
    def test_upgrade_preview_proves_exact_identity_without_writes(self) -> None:
        ...
        self.assertEqual(result["managerVersion"], "5.3.0")
...
class RealManagerPromotionTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        if external_carrier:
            ...
            init_path.write_text(init_path.read_text(encoding="utf-8").replace('5.3.0', '5.0.0'), encoding="utf-8")
            project_path.write_text(project_path.read_text(encoding="utf-8").replace('5.3.0', '5.0.0'), encoding="utf-8")
            ...
            init_path.write_text(init_path.read_text(encoding="utf-8").replace('5.0.0', '5.3.0'), encoding="utf-8")
            project_path.write_text(project_path.read_text(encoding="utf-8").replace('5.0.0', '5.3.0'), encoding="utf-8")
            git("add", "--all", cwd=self.candidate_source)
